...
public class AccountDAO extends Object {
    ...
    private void selectAccount () throws SQLException {
        ...
        // use dbConnection to create a Statement object
        // create a query string to select the data elements from the data store
        // execute the query
        // if no row is found throw a SQLException
        // otherwise initilize the DAO's fields with the returned values
    ...
    private void deleteAccount() throws SQLException {
        ...
        // begin: insert new code
        // use dbConnection to create a Statement object
        // create a query string to delete the row
        // execute the query
        // if no row is deleted throw a SQLException
        // close the statement object
        // end: insert new code
