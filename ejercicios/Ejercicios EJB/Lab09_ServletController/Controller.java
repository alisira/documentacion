...
public class Controller extends HttpServlet {
  ...
  private static String CUSTOMER_SCREEN = "/J2EEApp/ShowCustomerAccts";
  ...
  protected void processRequest(HttpServletRequest request,HttpServletResponse response) throws ServletException, java.io.IOException {
    ...
    // get HttpSession object from request store to varible named "session"
    // create an HttpSesstion object if first time in
    // end: insert new code


    // begin: insert new code
    // create a String variable named "currAction" and initialize
    // it with the request parameter named "action"
    // output the value of currAction using println
    // end: insert new code
    ...
    if (currAction == null) {
      ...
      if (currAction.equals("validateLogin")) {
        ...
        // if the parameters are not valid or the login attempt fails
        // 		set the url to the login error screen
        // else
        // 		set the url to the customer screen (to display customer data)
        // end: insert new code
    ...
    if (url == CUSTOMER_SCREEN) {
      ...
      try {
        // begin: insert new code
        // retrieve a CustomerWithAcctsData object from the BankMgr
        // call displayCustomerWithAccts
        // end: insert new code
      } catch (Exception e) {
...
/***********************************************************************************/
  ...
  private void displayCustomerWithAccts(HttpServletResponse response, CustomerWithAcctsData pCWAD)
    ...
    // begin: insert new code
		...
		// create a PrintWriter object named "out"
		// end: insert new code
    ...
    if ((pCWAD.getAccounts()).isEmpty()) {
      ...
      while (i.hasNext()) {
        ...
        // begin: insert new code
        // output the table elements; acctNumber, balance, description
        // use this format...
        //		<tr><td> acctNumber </td>
        //			<td> balance </td>
  ...
  private boolean loginUser(java.lang.String username,java.lang.String password, HttpSession session) {
    ...
    try {
      ...
      // begin: insert new code
      // store the user id to the session using the attribute name "userID"
      // end: insert new code
