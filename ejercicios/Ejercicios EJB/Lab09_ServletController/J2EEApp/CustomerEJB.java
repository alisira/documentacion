...
public class CustomerEJB implements EntityBean {
    ...
    public CustomerWithAcctsData getCustomerWithAcctsData() {
        System.out.println("Entering CustomerEJB.getCustomerWithAcctsData()");
        ...
        try {
            ...
            if (acctList == null) {
                ...
                while ( ali.hasNext() ) {
                    accounts.addElement(((Account)ali.next()).getAccountData());
                }
            }
        } catch (Exception ex) {
            throw new EJBException("CustomerEJB.getCustomerWithAcctsData " +
                                    ex.getMessage());
        }
        System.out.println("Leaving CustomerEJB.getCustomerWithAcctsData()");
        return (new CustomerWithAcctsData(this.getCustomerData(), accounts));
    }
